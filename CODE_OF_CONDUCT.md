...
leaders responsible for enforcement, privately. This project has one confidential channel: GitHub's
private vulnerability reporting, on the **Security** tab of this repository. It is reserved for
security reports, but a conduct report sent there reaches only the maintainers, which is what
matters. You may also contact an organisation owner of
[Motrix-Energy](https://github.com/Motrix-Energy) directly on GitHub.
